...
namespace RailRoadVPN
{
    ...
    public class ServiceAPI
    {
        ...
        {
            this.logger.log(System.String.Format("getUserByPincode: UserUuid={0}, DeviceId={1}, VirtualIp={2}, DeviceIp={3}, Location={4}, IsActive={5}", UserUuid, DeviceId, VirtualIp, DeviceIp, Location, IsActive));
